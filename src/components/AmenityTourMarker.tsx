...
const amenityIcon = L.divIcon({
  ...
  className: "amenity-tour-marker",
  iconSize: [40, 40],
  iconAnchor: [20, 20],
});

interface AmenityTourMarkerProps {
  tour: AmenityTour;
  onSelect: (tour: AmenityTour) => void;
}

const AmenityTourMarker = memo<AmenityTourMarkerProps>(({ tour, onSelect }) => {
  return (
    <Marker
...
export default AmenityTourMarker;